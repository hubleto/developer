...
> **NOTE** This is developer's documentation. If you want to read about apps included in the default Hubleto package, read [this](../apps) or [this](https://help.hubleto.eu/v1/en/apps/community).
