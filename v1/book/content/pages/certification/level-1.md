...
<a class="btn" href="level-1/lesson-5"><span class="text">Open lesson #5</span></a> <span class="inline-flex items-center gap-2 align-middle ml-2 rounded-full border border-blue-200/25 bg-blue-400/5 px-2 py-1 text-xs font-medium leading-none text-blue-200/90"><i class="fas fa-video text-[0.7rem]" aria-hidden="true"></i><span>Video available</span></span>
...
<a class="btn" href="level-1/lesson-7"><span class="text">Open lesson #7</span></a> <span class="inline-flex items-center gap-2 align-middle ml-2 rounded-full border border-blue-200/25 bg-blue-400/5 px-2 py-1 text-xs font-medium leading-none text-blue-200/90"><i class="fas fa-video text-[0.7rem]" aria-hidden="true"></i><span>Video available</span></span>
...
<a class="btn" href="level-1/lesson-8"><span class="text">Open lesson #8</span></a> <span class="inline-flex items-center gap-2 align-middle ml-2 rounded-full border border-blue-200/25 bg-blue-400/5 px-2 py-1 text-xs font-medium leading-none text-blue-200/90"><i class="fas fa-video text-[0.7rem]" aria-hidden="true"></i><span>Video available</span></span>
...
<a class="btn" href="level-1/lesson-9"><span class="text">Open lesson #9</span></a> <span class="inline-flex items-center gap-2 align-middle ml-2 rounded-full border border-blue-200/25 bg-blue-400/5 px-2 py-1 text-xs font-medium leading-none text-blue-200/90"><i class="fas fa-video text-[0.7rem]" aria-hidden="true"></i><span>Video available</span></span>
...
<a class="btn" href="level-1/lesson-10"><span class="text">Open lesson #10</span></a> <span class="inline-flex items-center gap-2 align-middle ml-2 rounded-full border border-blue-200/25 bg-blue-400/5 px-2 py-1 text-xs font-medium leading-none text-blue-200/90"><i class="fas fa-video text-[0.7rem]" aria-hidden="true"></i><span>Video available</span></span>
