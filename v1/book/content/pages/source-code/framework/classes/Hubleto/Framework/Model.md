...
### ƒ getLatestInstalledMigration

Looks for installed migrations in the database

```php
private getLatestInstalledMigration(\Hubleto\Framework\Enums\InstalledMigrationEnum $configKey): int
```
