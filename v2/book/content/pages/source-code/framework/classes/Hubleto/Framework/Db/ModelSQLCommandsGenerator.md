...
# \Hubleto\Framework\Db\ModelSQLCommandsGenerator
...
```php
public getSqlCreateTableCommands(\Hubleto\Framework\Interfaces\ModelInterface $model): array
```
...
### ƒ getSqlCreateIndexesCommands

Returns SQL commands for index creation

```php
public getSqlCreateIndexesCommands(\Hubleto\Framework\Interfaces\ModelInterface $model): array
```
...
### ƒ getSqlCreateForeignKeysCommands

Get SQL commands for foreign key creation.

```php
public getSqlCreateForeignKeysCommands(\Hubleto\Framework\Interfaces\ModelInterface $model): array
```
...
### ƒ getSqlDropForeignKeysCommands

Get SQL commands for foreign key removal.

```php
public getSqlDropForeignKeysCommands(\Hubleto\Framework\Interfaces\ModelInterface $model): array
```
...
### ƒ getSqlDropTableIfExists

Drop model's SQL table if it exists

```php
public getSqlDropTableIfExists(\Hubleto\Framework\Interfaces\ModelInterface $model): array
```
