...
> **NOTE** This is developer's documentation. If you want to read about apps included in the default Hubleto package, read [this](../apps) or [this](https://help.hubleto.eu/v2/en/apps/community).

## Create an app

Easiest way to create an app is to run `php hubleto create app MyFirstApp` in your Hubleto project folder.

More about creating Hubleto apps is [here](apps/development/create-app).
