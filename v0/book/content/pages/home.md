...
<div class="grid gap-4 mt-8 md:grid-cols-2">
  <div class="card border-yellow-300">
    <div class="card-header bg-yellow-950 text-yellow-200">Introduction</div>
  ...
  <div class="card border-green-300">
    <div class="card-header bg-green-950 text-green-200">Development</div>
    <div class="card-body flex flex-col gap-2">
  ...
  <div class="card border-blue-300">
    <div class="card-header bg-blue-950 text-blue-200">Application repositories</div>
    <div class="card-body flex flex-col gap-2">
  ...
  <div class="card border-stone-300">
    <div class="card-header bg-stone-900 text-stone-200">Join us</div>
    <div class="card-body flex flex-col gap-2">
