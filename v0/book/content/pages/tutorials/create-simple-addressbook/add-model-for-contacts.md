...
> **IMPORTANT** | Description of columns is very important part of Hubleto app. We recommend reading [this guide](../docs/erp/advanced-development/data-management/understanding-columns-in-model) to understand *Hubleto columns* much better.
