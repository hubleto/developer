...
Within a View Controller you can access submitted form data through various parameter getters like  `$this->router()->urlParamAsInteger("newValue")`. For example, you can work with these values to decide what `viewParams` to pass to the View or decide what View to set.
